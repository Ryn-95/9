    ...
    <section ref={containerRef} className="relative w-full min-h-screen bg-white flex flex-col justify-center pt-20 pb-20 px-4 md:px-12 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-[1600px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col items-start pt-10 lg:pt-0">
            ...
            <FadeIn delay={0.4} className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto items-center">
                <Magnetic strength={0.2}>
                    <a href="https://calendly.com/contact-9secondes/30min" target="_blank" rel="noopener noreferrer">
                ...
                <Magnetic strength={0.1}>
                    <a href="https://wa.me/33767981273" target="_blank" rel="noopener noreferrer" className="w-14 h-14 flex items-center justify-center rounded-full border border-gray-200 bg-white hover:bg-gray-50 transition-all text-black hover:scale-110 group" aria-label="WhatsApp">
                        <svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 opacity-80 group-hover:opacity-100 transition-opacity">
